...
typedef enum {
    ...
    rdpa_port_attr_cfg = 1, /* cfg : RW : aggregate/20 port_dp(rdpa_port_dp_cfg_t) : Logical port configuration */
    rdpa_port_attr_tm_cfg = 2, /* tm_cfg : RW : aggregate/12 port_tm(rdpa_port_tm_cfg_t) : TM configuration */
    rdpa_port_attr_sa_limit = 3, /* sa_limit : RW : aggregate/4 port_sa_limit(rdpa_port_sa_limit_t) : SA limit configuration */
    rdpa_port_attr_def_flow = 4, /* def_flow : RW : aggregate/56 classification_result(rdpa_ic_result_t ) : DS default flow classification. Wifi: last default flo */
    rdpa_port_attr_stat = 5, /* stat : R : aggregate/48 stat(rdpa_port_stat_t) : Port statistics */
    rdpa_port_attr_flow_control = 6, /* flow_control : RW : aggregate/18 port_flow_control(rdpa_port_flow_ctrl_t) : The port flow control */
    rdpa_port_attr_mirror_cfg = 7, /* mirror_cfg : RW : aggregate/8 port_mirror_cfg(rdpa_port_mirror_cfg_t) : Port mirroring configuration */
    rdpa_port_attr_vlan_isolation = 8, /* vlan_isolation : RW : aggregate/2 vlan_isolation(rdpa_port_vlan_isolation_t) : LAN port VLAN isolation control */
    rdpa_port_attr_transparent = 9, /* transparent : RW : bool/1 : LAN port transparent control */
    rdpa_port_attr_loopback = 10, /* loopback : RW : aggregate/16 port_loopback_conf(rdpa_port_loopback_t) : Port loopbacks */
